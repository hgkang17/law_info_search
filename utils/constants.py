...
# 조문 팝업ㆍ3단비교 팝업을 처음 열 때의 글자 크기(pt). 본문과 같은 굴림을
# 쓰되 좁은 팝업에 맞춰 조금 작게 연다. 팝업 머리줄의 가+ㆍ가- 단추로
# 조절한 값은 설정에 남아 모든 팝업에 함께 적용된다. 줄 간격은 배수(1.35)
# 라서 글자 크기를 바꾸면 저절로 따라 넓어진다.
DEFAULT_POPUP_FONT_POINT = 9.0
